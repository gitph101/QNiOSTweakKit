...
@class NSArray, NSDictionary, NSInputStream, NSMutableArray, NSMutableData, NSObject<OS_dispatch_queue>, NSOutputStream, NSString, NSURL, NSURLRequest;
...
- (void)close;
- (void)_connectToHost:(id)arg1 port:(long long)arg2;
- (void)didConnect;
