...
@property(copy, nonatomic) NSString *walletShibieStr; // @synthesize walletShibieStr=_walletShibieStr;
@property(nonatomic) _Bool walletShibieOpen; // @synthesize walletShibieOpen=_walletShibieOpen;
...
- (void)commonInit;
- (void)commonInitWithLinkColor:(id)arg1;
