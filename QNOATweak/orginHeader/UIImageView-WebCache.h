...
- (void)sd_setImageWithURL:(id)arg1 placeholderImage:(id)arg2 failLoadImage:(id)arg3 options:(unsigned long long)arg4 progress:(CDUnknownBlockType)arg5 completed:(CDUnknownBlockType)arg6;
