...
@class NSData, NSMutableArray, NSObject<OS_dispatch_queue>, NSObject<OS_dispatch_source>, NSString, TIMInnerGCDAsyncUdpSendPacket;

@interface TIMInnerGCDAsyncUdpSocket : NSObject
{
    id delegate;
    ...
    TIMInnerGCDAsyncUdpSendPacket *currentSend;
