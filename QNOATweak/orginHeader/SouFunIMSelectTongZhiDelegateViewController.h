...
@interface SouFunIMSelectTongZhiDelegateViewController : UIViewController <UITableViewDataSource, UITableViewDelegate, UICollectionViewDataSource, UICollectionViewDelegate, UISearchBarDelegate>
{
    MBProgressHUD *_hud;
    id <backDelegateHeadWithArray> _delegate;
...
@property(nonatomic) __weak id <backDelegateHeadWithArray> delegate; // @synthesize delegate=_delegate;
