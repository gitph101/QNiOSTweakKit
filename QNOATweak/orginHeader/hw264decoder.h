...
- (void)DoDecCB:(char *)arg1 withU:(char *)arg2 withV:(char *)arg3 withDataLenw:(int)arg4 withDataLenh:(int)arg5 withStideY:(int)arg6 withStrideUV:(int)arg7 withFrameIndex:(int)arg8 withDataFormat:(int)arg9 withCodecFormat:(int)arg10;
