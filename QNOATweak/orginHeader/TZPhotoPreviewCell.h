...
@class NSString, TZAssetModel, UIImageView, UIScrollView, UIView;

@interface TZPhotoPreviewCell : UICollectionViewCell <UIGestureRecognizerDelegate, UIScrollViewDelegate>
{
    double _aspectRatio;
    TZAssetModel *_model;
