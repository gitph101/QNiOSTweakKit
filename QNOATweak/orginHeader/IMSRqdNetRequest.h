...
@class IMSRqdHttpRequest, IMSRqdReqDataPackage, NSData, NSHTTPURLResponse, NSMutableData, NSMutableURLRequest, NSString, NSURLConnection;

@interface IMSRqdNetRequest : NSObject
{
    ...
    IMSRqdReqDataPackage *_reqDataPkg;
    unsigned long long _networkType;
    IMSRqdHttpRequest *_httpRequest;
}

@property(retain, nonatomic) IMSRqdHttpRequest *httpRequest; // @synthesize httpRequest=_httpRequest;
...
@property(retain, nonatomic) IMSRqdReqDataPackage *reqDataPkg; // @synthesize reqDataPkg=_reqDataPkg;
