...
@class IMSRqdRequestPackage, NSString;

@interface IMSRqdReqDataPackage : NSObject
{
    IMSRqdRequestPackage *requestPackage;
    NSString *reqKey;
    NSString *reqServant;
    NSString *reqFunc;
    NSString *encKey;
...
@property(retain, nonatomic) IMSRqdRequestPackage *requestPackage; // @synthesize requestPackage;
- (void)dealloc;
