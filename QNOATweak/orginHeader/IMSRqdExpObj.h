...
@class IMSRqdAppInfo, IMSRqdAppSession, NSArray, NSDictionary, NSMutableDictionary, NSString;

@interface IMSRqdExpObj : IMSRqdLocalObject
{
    NSString *crashType;
    long long cashTime;
    ...
    IMSRqdAppSession *sessionInfo;
    NSString *_gatewayIp;
}

@property(copy, nonatomic) NSString *gatewayIp; // @synthesize gatewayIp=_gatewayIp;
@property(retain, nonatomic) IMSRqdAppSession *sessionInfo; // @synthesize sessionInfo;
...
@property(retain, nonatomic) IMSRqdAppInfo *appInfo; // @synthesize appInfo;
