...
@class IMSRqdLocalStrategy, NSMutableArray, NSMutableDictionary, NSString;

@interface IMSRqdFilePersistHandler : NSObject
{
    NSString *folderPath;
    ...
    IMSRqdLocalStrategy *commonStrategyData;
    _Bool dataLoaded;
