...
@class EDAMAuthenticationResult, EDAMBusinessQuery, EDAMBusinessQueryResult, EDAMClientUsageMetrics, EDAMLazyMap, EDAMLinkedNotebook, EDAMNote, EDAMNoteCollectionCounts, EDAMNoteEmailParameters, EDAMNoteFilter, EDAMNoteList, EDAMNotebook, EDAMNotesMetadataList, EDAMNotesMetadataResultSpec, EDAMRelatedQuery, EDAMRelatedResult, EDAMRelatedResultSpec, EDAMResource, EDAMResourceAttributes, EDAMSavedSearch, EDAMSharedNotebook, EDAMSharedNotebookRecipientSettings, EDAMSyncChunk, EDAMSyncChunkFilter, EDAMSyncState, EDAMTag, NSArray, NSData, NSString;
