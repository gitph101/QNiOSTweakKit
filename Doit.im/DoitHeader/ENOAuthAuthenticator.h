...
#import "ENLoadingViewControllerDelegate.h"
#import "ENOAuthViewControllerDelegate.h"

@class ENCredentialStore, ENOAuthViewController, NSArray, NSLocale, NSMutableData, NSString, NSURLResponse, UINavigationController, UIViewController;
